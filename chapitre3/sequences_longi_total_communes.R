...
Prix_communes_appartement<- Montableau_Appartement_200_all_45138

Prix_communes_appartement<- Montableau_Appartement_1000_all_5091tiles%>%
...
Prix_communes_appartement<- Montableau_Appartement_communes[,c(3:7)]
...
UMZ<-as.data.frame(Prix_communes_appartement)
