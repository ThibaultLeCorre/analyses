...
for (cetteAnneeLa in annees){
  ...
  setwd("~/Sauvegarde_figures/Appartement_carreau_200_span_500_45138carreaux")
  pdf(file=paste0(~"Sauvegarde_figures/Appartement_carreau_200_span_500_45138carreaux",cetteAnneeLa,".pdf"),width = 10, height = 5)
  tilesLayer(osmTiles)
...
Montableau_Appartement_200_all_45138<- Montableau_Appartement
rm(carreaux_resumes, breaks_ratio)
Montableau_Appartement_200_all_45138<-Montableau_Appartement_200_all_45138%>% select(-geometry)

setwd("~/Projets/Prix_evol_2/table_results_prix_evol_2")
write.csv2(x=Montableau_Appartement_200_all_45138,file = "Montableau_Appartement_200_all_45138.csv", row.names=FALSE, fileEncoding = "UTF-8")
