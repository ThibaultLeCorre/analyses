...
for (cetteAnneeLa in annees){
  ...
  setwd("~/Sauvegarde_figures/Maison_carreau200_span500_40253")
  pdf(file=paste0(~"Sauvegarde_figures/Maison_carreau_200_span500_40253",cetteAnneeLa,".pdf"),width = 10, height = 5)
  tilesLayer(osmTiles)
...
write.csv2(x=Montableau_Maison_200_all,file = "Montableau_Maison_200_all_40253.csv", row.names=FALSE, fileEncoding = "UTF-8")
